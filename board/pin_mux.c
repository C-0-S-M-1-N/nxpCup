...
- {pin_num: K3, pin_signal: PIO2_4/WUU0_IN17/FC9_P0/SDHC0_CLK/SCT0_OUT2/PWM1_A1/FLEXIO0_D12/SMARTDMA_PIO24/FLEXSPI0_B_DATA0/SINC0_MCLK1/SAI0_RXD1, label: 'P2_4/TP26/J12[5]/J3[11]/SJ5[3]',
  identifier: PWM1_A1}
- {pin_num: A6, pin_signal: PIO0_25/FC1_P1/CT0_MAT1/ADC0_B17, label: 'P0_25/J2[12]', identifier: STEER}
...
- pin_list:
  ...
  - {pin_num: A6, peripheral: CTIMER0, signal: 'MATCH, 1', pin_signal: PIO0_25/FC1_P1/CT0_MAT1/ADC0_B17, identifier: ''}
  ...
  - {pin_num: B4, peripheral: CTIMER1, signal: 'MATCH, 1', pin_signal: PIO1_3/WUU0_IN7/TRIG_OUT1/FC3_P3/CT1_MAT1/SCT0_IN7/FLEXIO0_D11/ENET0_MDIO/SAI1_RXD0/CAN0_RXD/TSI0_CH3/ADC0_A19/CMP0_IN1}
  - {pin_num: K17, peripheral: PWM1, signal: 'X, 1', pin_signal: PIO3_19/FC7_P6/CT2_MAT1/PWM1_X1/FLEXIO0_D27/SMARTDMA_PIO19/SAI1_RX_FS}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinMux(PORT1, 3U, kPORT_MuxAlt4);
    ...
    /* PORT3_19 (pin K17) is configured as PWM1_X1 */
    PORT_SetPinMux(PORT3, 19U, kPORT_MuxAlt5);
